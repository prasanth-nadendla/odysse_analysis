...
class DataLoader_Cluster:
    ...
    def load_data_to_db(self, data: pd.DataFrame, table_name: str = 'Cluster_analysis'):
        """
        ...
        Args:
            ...
            table_name (str): The name of the table to create or replace. Defaults to 'Cluster_analysis'.
        """
